...
export enum SecurityEventType {
  ...
  TICKET_SCAN_VALID = 'TICKET_SCAN_VALID',
  TICKET_SCAN_ALREADY_USED = 'TICKET_SCAN_ALREADY_USED',
  TICKET_SCAN_INVALID = 'TICKET_SCAN_INVALID',
  TICKET_SCAN_EVENT_CLOSED = 'TICKET_SCAN_EVENT_CLOSED',
  TICKET_SCAN_NOT_ASSIGNED = 'TICKET_SCAN_NOT_ASSIGNED',
  TICKET_SCAN_WRONG_VENUE = 'TICKET_SCAN_WRONG_VENUE',
  TICKET_SCAN_WRONG_SECTOR = 'TICKET_SCAN_WRONG_SECTOR',
  TICKET_SCAN_CANCELLED = 'TICKET_SCAN_CANCELLED',
  TICKET_SCAN_BOOKING_CANCELLED = 'TICKET_SCAN_BOOKING_CANCELLED',
}
